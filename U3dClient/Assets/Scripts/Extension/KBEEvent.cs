...
namespace KBEngine
{
    ...
    public class KBEEvent
    {
		...
		//kbe向lua激发消息
		public struct LuaPair
		{
			public LuaTable luatable;
			public string eventname;

		}
		public struct LuaEventObj
		{
			public LuaPair info;
			public string eventname;
			public object[] args;
		};
		static Dictionary<string,List<LuaPair>> lua_out_events = new Dictionary<string, List<LuaPair>>();
		static LinkedList<EventObj> lua_firedEvents_out = new LinkedList<EventObj>();
		static LinkedList<EventObj> lua_doingEvents_out = new LinkedList<EventObj>();
		...
		public static void clearFiredEvents()
		{
			...
			monitor_Enter(lua_out_events);
			lua_firedEvents_out.Clear();
			monitor_Exit(lua_out_events);
			lua_doingEvents_out.Clear();
...
//				return;
		...
		/// <returns></returns>
		public static bool hasRegisterLuaOut(string eventname)
		{
			return _hasLuaRegister(lua_out_events, eventname);
		}
		private static bool _hasLuaRegister(Dictionary<string, List<LuaPair>> events, string eventname)
		{
			bool has = false;
        ...
        public static bool registerLuaOut(string eventname, object obj, string funcname)
        {
	        return false;
        }
